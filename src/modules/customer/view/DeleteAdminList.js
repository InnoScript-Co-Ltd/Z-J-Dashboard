...
export const DeleteAdminList = () => {
    ...
    const columns = useRef(adminPayloads.delColumns);
    ...
    const init = useCallback(async () => {
        ...
        const response = await adminServices.delIndex(dispatch, {...paginateParams, search: ""});
    ...
    const restoreDialogBox = async (id) => {
        confirmDialog({
            ...
            accept: async () => { 
                const response = await adminServices.restore(dispatch, id);
                if(response.status === 200) {
                    init();
                }
            },
    ...
    const HeaderRender = () => {
        return (
            <div className="grid">
                <div className="col-3">
                    <TableSearch
                        tooltipLabel={adminPayloads.delColumns}
        ...
        <>
            ...
            <div className="w-full p-3">
                    <DataTable
                        ...
                        globalFilterFields={adminPayloads.delColumns}
